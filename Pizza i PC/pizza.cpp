...
class ChomaPizzaBuilder : public PizzaBuilder {
public:
	void buildDough() override
	{
...
int main()
{
	...
	ChomaPizzaBuilder ChomaBuilder;
	cook.makePizza(ChomaBuilder);
	Pizza ChomaPizza = ChomaBuilder.getPizza();
	ChomaPizza.displayPizza();
	return 0;
}